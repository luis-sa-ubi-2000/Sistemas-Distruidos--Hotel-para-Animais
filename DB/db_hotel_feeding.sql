...
CREATE TABLE `feeding` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKs7vvl7sx2pkbw3ll4nqveu9q4` (`id_pet`),
  CONSTRAINT `FKs7vvl7sx2pkbw3ll4nqveu9q4` FOREIGN KEY (`id_pet`) REFERENCES `pet` (`id`)
...
INSERT INTO `feeding` VALUES (2,'Canned Food',4);
